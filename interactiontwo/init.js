...
let colArray=[
    ...
    [ "rgba(255,255,255,1)", "rgba(153,153,153,1)", "rgba(0,0,0,1)",
        ...
        "rgb(34,255,0)","rgb(208,0,255)", "rgb(0,255,255)"
    ],

    [ "rgba(255,255,255,.67)", "rgba(153,153,153,.67)", "rgba(0,0,0,.67)",
        "rgba(204,0,0,.67)","rgba(255,204,51,.67)","rgba(51,51,255,.67)",
        "rgb(34,255,0,0.67)","rgb(208,0,255,.67)", "rgb(0,255,255,.67)"
    ],

    [ "rgba(255,255,255,.33)", "rgba(153,153,153,.33)", "rgba(0,0,0,.33)",
        "rgba(204,0,0,.33)","rgba(255,204,51,.33)","rgba(51,51,255,.33)",
        "rgb(34,255,0,.33)","rgb(208,0,255,.33)", "rgb(0,255,255,.33)"
    ]
]