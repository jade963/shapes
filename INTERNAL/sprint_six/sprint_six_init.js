...
class Ellipse{
    constructor(x,y,radiusX,radiusY,rotation,startAngle,endAngle,fill,stroke,fillC,strokeC,lineWidth,dash){
        this.x = x
        this.y = y
    ...
    update(){
        this.basicEllipse(this.x, this.y, this.radiusX, this.radiusY, this.rotation,this.startAngle,this.endAngle,
            this.fill,this.stroke,this.fillC,this.strokeC,this.lineWidth,this.dash)
    }
}
...
function basicEllipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle, fill, stroke, fillC, strokeC, lineWidth,dash){
    if (dash === "small"){
        ctx.setLineDash([4,16]);
        ctx.lineDashOffset = 4;
    }
