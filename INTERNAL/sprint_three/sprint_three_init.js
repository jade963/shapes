...
class Button extends InteractiveObject{
    constructor(x, y, w, h, lineW, hoverLine, fillC,strokeC, hoverC,selectedC,text, textC){
        super();
        this.x = x;
        this.y = y;
        this.w = w;
...
class Swatch extends Button{
    constructor(x, y, w, h, lineW, hoverLine, fillC, hoverC, selectedC, strokeC){
        super(x, y, w, h, lineW, hoverLine, fillC, hoverC, selectedC, strokeC);
        this.name = Swatch;
        this.inBounds = false;
    }
    update(){
...
class Toggler extends Button{
    constructor(x, y, w, h, lineW, hoverLine,fillC,strokeC,hoverC,selectedC,fullText,type,status){
        super(x, y, w, h, lineW, hoverLine,fillC,strokeC,hoverC,selectedC);
...
class Colour_Button extends Button{
    constructor(x,y,w,h,lineW,hoverLine,fillC,strokeC,hoverC,selectedC,text,textC){
        super(x,y,w,h,lineW,hoverLine,fillC,strokeC,hoverC,selectedC,text,textC)
